...
import {Search,RefreshCw,Plus,ChevronDown,Shield,Users} from "lucide-react";

  // Main component for team administration interface
export default function TeamsAdmin({
  ...
  useEffect(() => {
    ...
    // Filter users for PM and member selection
  ...
  function openDetailModal(team: TeamWithMembers) {
    ...
    // Update team in the list after editing
...
function FloatingInput({
  ...
  // Component for displaying team members inline with add/remove functionality
